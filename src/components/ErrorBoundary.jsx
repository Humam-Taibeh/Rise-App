        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-4">
          <div className="bg-red-500/10 border border-red-500/30 rounded-3xl p-8 max-w-md text-center">
            ...
            {process.env.NODE_ENV === 'development' && (
              <details className="text-left mb-6 text-xs text-red-100 bg-black/30 p-3 rounded-2xl">
            ...
            <button
              ...
              className="w-full py-2 px-4 bg-red-600 hover:bg-red-700 text-white rounded-3xl font-medium transition-colors"
            >
              Reload Page
            </button>
          </div>
